...
\usepackage[a4paper,left=60pt,top=60pt,right=60pt,bottom=60pt,footskip=0.25in,heightrounded]{geometry}
...
\addtofooter{Brampton, Ontario}
\addtofooter{Canada - L6T 4N6}
\flushfooter%
       \end{minipage}%
       \par
       ...
       \begin{minipage}[t]{0.9\textwidth}
        ...
        \firstfooterelementtrue%
\addtofooter{{\Large\fixedphonesymbol}~\small 289-981-2649}
\addtofooter{\href{mailto:kesu.jp.public@gmail.com}{\emailsymbol~\ttfamily kesu.jp.public@gmail.com}}
        \flushfooter%
       \end{minipage}
       }
\makeatother
...
\newcommand\AtPageUpperMyleft[1]{\AtPageUpperLeft{%
 \put(\LenToUnit{\dimexpr\paperwidth-136pt-2\fboxrule\relax},\LenToUnit{-4.4cm}){#1}%
 }}%
\newcommand{\photo}[1]{%
